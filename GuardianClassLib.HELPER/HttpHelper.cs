...
namespace GuardianClassLib.HELPER
{
    public class HttpHelper
    {
        ...
        //string url = "http://apis.baidu.com/apix/apix_station_data/apix_telecom";
        //string param = "sid=13824&nid=0&cellid=291&ishex=0";
        //string result = GetRequest(url, param);
        ...
        #region 发送HTTP请求
        //string url = "http://apis.baidu.com/open189/templatesms/sendtemplatesms";
        //string param = "app_id=无&acceptor_tel=无&template_id=无&template_param=无&timestamp=无&sign=无";
